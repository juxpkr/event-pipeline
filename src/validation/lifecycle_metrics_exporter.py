...
class LifecycleMetricsExporter:
    ...
    def _build_lifecycle_metrics(self, audit_results: Dict) -> str:
        ...
        def add_metric(name: str, value: float, labels: Dict[str, str] = None, help_text: str = None):
            if help_text:
