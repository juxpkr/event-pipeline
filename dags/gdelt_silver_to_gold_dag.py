...
with DAG(
    ...
    dbt_transformation = DockerOperator(
        ...
        command="dbt seed --target prod && dbt run --target prod --select +stg_seed_mapping +stg_seed_actors_parsed +stg_actors_description +stg_gdelt_microbatch_events +gdelt_microbatch_country_analysis +gold_1st_global_overview +gold_2nd_country_events +gold_4th_daily_detail_summary",
